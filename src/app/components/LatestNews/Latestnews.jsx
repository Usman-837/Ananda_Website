            ...
            <div className='container'>
                ...
                <div className='flex gap-x-10'>
                    <div className='space-y-4'>
                        ...
                        <div className='flex gap-4'>
                            <div>
                                ...
                                <p className='text-[#939580]'>June</p>
                            </div>
                            <p className='text-4xl'>Photography is the important part
                                of wedding.</p>
                        </div>
                    </div>
                    <div className='space-y-7'>
                        {
                            NewsData.map((data) => (
                                <div key={data.id} className='flex gap-x-6'>
                                    <Image src={data.img} alt='latestnews' />
                                    <div className='space-y-4'>
                                        <p className='text-[28px] leading-9'>{data.title}</p>
